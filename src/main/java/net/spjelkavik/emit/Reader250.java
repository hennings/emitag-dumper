 ...
 */
public class Reader250 implements Runnable, SerialPortEventListener {
	...
	public void serialEvent(SerialPortEvent event) {
		...
		case SerialPortEvent.DATA_AVAILABLE:
			...
			if ( (now-lastEvent) > 500) {
				frame = new Frame();
				System.out.println("-- New frame - more than 500 ms...");
			}
...
//						this.asciiBadgeListener.setBadgeAndStationNumber(frame.getBadgeNo());
					}
					frame.add(c3);
